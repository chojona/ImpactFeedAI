      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 gap-12 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-12 lg:gap-10 lg:py-24">
        <div className="lg:col-span-6 lg:pr-4">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link
              href="/feed"
              className="inline-flex h-10 items-center justify-center gap-1.5 whitespace-nowrap rounded-md bg-[#00FF94] px-5 font-mono text-sm font-semibold text-[#080C10] transition hover:bg-[#00FF94]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00FF94]/40"
            >
            ...
            <Link
              href="/patterns"
              className="inline-flex h-10 items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-white/10 bg-white/[0.03] px-5 font-mono text-sm font-semibold text-zinc-100 transition hover:border-white/20 hover:bg-white/[0.06] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/20"
            >
